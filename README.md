...
* Integrated an ESP32 module with isolated 5V relay controls to safely drive external loads.
* Routed dedicated and accessible communication headers for SPI, I2C, and UART protocols.
...
| View | Image |
| :--- | :--- |
| **3D Board View** | ![3D View](Images/3D_ESP32.PNG) |
| **PCB Layout (Top & Bottom)** | ![PCB Layout](Images/PCB_32.PNG) |
| **System Schematic** | ![Schematic](Images/Schematic_32.PNG) |
